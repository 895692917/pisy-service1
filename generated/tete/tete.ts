...
export class tete__royaltyInfoResult {
  value0: Address;
  value1: BigInt;
...
export class tete extends ethereum.SmartContract {
  static bind(address: Address): tete {
    return new tete("tete", address);
  }
  ...
  royaltyInfo(tokenId: BigInt, value: BigInt): tete__royaltyInfoResult {
    let result = super.call(
      "royaltyInfo",
    ...
    return new tete__royaltyInfoResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_royaltyInfo(
    tokenId: BigInt,
    value: BigInt
  ): ethereum.CallResult<tete__royaltyInfoResult> {
    let result = super.tryCall(
      "royaltyInfo",
      "royaltyInfo(uint256,uint256):(address,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new tete__royaltyInfoResult(value[0].toAddress(), value[1].toBigInt())
    );
  }
